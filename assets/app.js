...
/* Embedded so the invoice — a self-contained document opened as a print window
   or downloaded as a standalone file — always shows the logo, with no relative
   path or network request that could fail outside the page's own origin. */
